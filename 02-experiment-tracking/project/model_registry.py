...
HPO_EXPERIMENT_NAME = "random-forest-experiment"
...
def run(data_path, log_top):
    ...
    # Retrieve the top_n log moel runs and log the models to Mlflow
    ...
    # Select the model with lowest test RMSE
    ...
    mlflow.register_model(
        ...
        name = "nyc-taxi-duration-regressor",
    )
